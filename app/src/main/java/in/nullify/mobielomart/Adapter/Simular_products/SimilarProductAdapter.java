...
public class SimilarProductAdapter extends RecyclerView.Adapter<SimilarProductAdapter.ViewHolder> {
    private List<SimilarProducts> products;
    private Context context;
    private int width=180,height=180;
    public SimilarProductAdapter(Context context, List<SimilarProducts> products) {
        this.products = products;
        this.context = context;
    }

    @Override
    public SimilarProductAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.home_newupdate_gride_style, viewGroup, false);
        width = viewGroup.getMeasuredWidth()/2;
        return new SimilarProductAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(SimilarProductAdapter.ViewHolder viewHolder, final int i) {
